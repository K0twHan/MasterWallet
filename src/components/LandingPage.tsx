...
// Şimdilik placeholder bir URL koyuyorum.
const WDK_LOGO_URL = "../assets/wdk-logo.png"; // LOGO URL'SİNİ BURAYA EKLEYİN
// ----------------------------------------------------------------------
    ...
    <div style={{ 
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', marginTop: '48px' }}>
          ...
          <button style={styles.secondaryBtnLarge}>
            Explore Strategies
          </button>
        </div>
      ...
      <section id="agents" style={{ padding: '100px 24px', borderTop: '1px solid #222' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '60px' }}>
            
            <div style={{ flex: 1, minWidth: '300px' }}>
                <h2 style={{ fontSize: '40px', fontWeight: '700', marginBottom: '24px', lineHeight: '1.2' }}>
                    Let AI Do the Heavy Lifting.
                </h2>
                <p style={{ fontSize: '18px', color: '#999', lineHeight: '1.6', marginBottom: '32px' }}>
                    Professional DeFi trading requires monitoring pools 24/7. Our AI Agents do that for you.
                </p>
            ...
            <div style={{ flex: 1, minWidth: '300px' }}>
                ...
                <div style={{
                    ...
                    <div style={{display:'flex', justifyContent:'space-between', marginBottom: '20px'}}>
                        <span style={{fontWeight:'bold', color: '#fff'}}>🤖 Agent Active</span>
                        <span style={{color: '#28a745'}}>● Running</span>
                    </div>
                    <div style={{background: '#000', borderRadius: '12px', padding: '16px', marginBottom: '12px', fontFamily: 'monospace', fontSize: '13px', color: '#0f0'}}>
                    ...
                    <button style={{width:'100%', padding:'12px', borderRadius:'8px', background:'#333', border:'none', color:'#fff', cursor:'default'}}>View Dashboard</button>
                </div>
            </div>
      ...
      <footer style={{
        ...
        <p style={{ fontSize: '14px', marginTop: '18px' }}>
          Built for the <b>Tether WDK Hackathon</b>. Empowering financial freedom.
        </p>
      </footer>
...
function FeatureCard({ icon, title, desc, highlight }: { icon: string, title: string, desc: string, highlight?: string }) {
    ...
    return (
        ...
        >
            ...
            <h3 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '16px', color: hover ? '#fff' : '#eee' }}>
                {title}
            </h3>
...
function ListItem({ text }: { text: string }) {
    return (
        <li style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '16px', color: '#ccc' }}>
