...
export default function PoolDetail({
  ...
  const handleDeposit = () => {
    ...
    const platformFee =
      (parseFloat(token1Amount) + parseFloat(token2Amount)) * 0.001; // 0.1% platform fee
    setPendingDeposit({
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "16px", fontSize: "16px" }}>
              ...
              <br />
              <strong>
                {pendingDeposit.amount1} {pendingDeposit.token1}
              </strong>{" "}
              +{" "}
              <strong>
                {pendingDeposit.amount2} {pendingDeposit.token2}
              </strong>
            </div>
            <div
              style={{
            ...
            >
              <div>
                Fee: <strong>${pendingDeposit.fee.toFixed(4)}</strong>
              </div>
              <div>
                Platform Fee:{" "}
                <strong>${pendingDeposit.platformFee.toFixed(4)}</strong>
              </div>
            </div>
            <div
              style={{
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        `https://etherscan.io/address/${pool.contract}`,
                        "_blank"
                      )
                    }
                    style={{
          ...
          >
            ...
            >
              <button
                ...
                style={{
                  flex: 1,
                  background:
                    activeTab === "deposit" ? "#FF6B00" : "transparent",
                  border: "none",
                  borderRadius: "10px",
                  padding: "12px",
                  color: "#fff",
              ...
              <button
                ...
                style={{
                  flex: 1,
                  background:
                    activeTab === "withdraw" ? "#FF6B00" : "transparent",
                  border: "none",
                  borderRadius: "10px",
                  padding: "12px",
                  color: "#fff",
            ...
            {activeTab === "deposit" ? (
              ...
              <>
                ...
                <button
                  onClick={() =>
                    handleWithdraw(0, withdrawPercentage.toString())
                  }
                  ...
                  style={{
                    ...
                    fontWeight: "700",
                    cursor:
                      withdrawPercentage === 0 ? "not-allowed" : "pointer",
                    transition: "all 0.2s",
                    fontFamily: "'Space Grotesk', sans-serif",
                  }}
                  onMouseOver={(e) => {
                ...
                >
                  {withdrawPercentage === 0
                    ? "Select Amount"
                    : `Withdraw ${withdrawPercentage}% Liquidity`}
                </button>
              </>
            )}
          </div>
